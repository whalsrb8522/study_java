...
public class 과제 {
	...
	public static void doSub(int[] arr) {
		System.out.printf("\n결과 : %d", arr[0] - arr[1]);
	}
	
	public static void doMul(int[] arr) {
		System.out.printf("\n결과 : %d", arr[0] * arr[1]);
	}
	
	public static void doDiv(int[] arr) {
		System.out.printf("\n결과 : %f", (double) arr[0] / arr[1]);
	}
	
	public static void doRem(int[] arr) {
		System.out.printf("\n결과 : %d", arr[0] % arr[1]);
	}
}
